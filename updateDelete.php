        ...
        <table class="table table-color  table-hover">
                <thead>
                     ...
                     <tbody>
                            ...
                            <?php
                                $count = 0;
                                $query = mysqli_query($db,"SELECT * FROM interns");
             ...
             <td><span class="badge badge-success w-75 py-2"><a href="server.php?del=<?php echo $row['id']; ?>"data-toggle="tooltip" title="Delete"
                data-placement="top">
                <i class="fas fa-trash-alt fa-lg text-danger">
                </i></a></span></td>
             <td> <div class="col-1">
                <a href="edit-intern.php?edit=<?php echo $row['id']; ?>" data-toggle="tooltip" title="Edit"
                data-placement="top">
