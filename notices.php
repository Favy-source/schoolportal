            ...
            <div class=" col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                ...
                sidebar-link"><i class="fas fa-envelope text-light fa-lg mr-3"></i>
                    ...
                    <li class="nav-item"><a href="./notices.php" class="nav-link text-white p-3 mb-2
                        current"><i class="fas fa-envelope text-light fa-lg mr-3"></i>
                Notices</a></li>
                ...
                <div class="row align-items-center">
                     <div class="col-xl-6 col-12 mb-4 mb-xl-0">
                       ...
                       <table class="table table-striped bg-light text-center">
                           <thead>
                               <tr class="text-dark">
                                   <th>interns must be notified on any new update</th>
                                   <th></th>
                                   <th></th>
                                   <th></th>
                                   <th></th>
                       ...
                       <form action="notices.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  id="title" class="form-control py-2 mb-3" name="title" required="require">
                            <textarea type="text" id="texts" name="texts"required="require" class="form-control py-2 mb-3"></textarea>
                            <!-- <input type="file" id="myfile" name="myfile" multiple><br><br> -->
                            <button class="btn btn-block text-uppercase 
                            font-weight-bold text-light bg-button py-2 mb-5" type="submit" name="send_msg">Send to interns</button>
                        </div>
                    </form>
