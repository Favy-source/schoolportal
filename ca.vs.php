...
<section>
    <div class="container-fluid">
                ...
                <div class="row align-items-center">
                     <div class="col-xl-6 col-12 mb-4 mb-xl-0">
                       ...
                       <table class="table table-striped bg-light text-center">
                           <thead>
                               <tr class="text-dark">
                                   <th>create new assignments here!</th>
                                   <th></th>
                                   <th></th>
                                   <th></th>
                                   <th></th>
                       ...
                       <!---Pagination-->
                       <form action="ca.vs.php" method="POST">
                       <?php include('error.php') ?>
                        <!-- <div class="form-group">
                            <input type="file" id="myfile" name="file"  required="require" multiple><br><br> -->
                            <button class="btn btn-block text-uppercase 
                            font-weight-bold text-light bg-button py-2 mb-5"  type="submit" name="assign_ment"> <a href="./file-upload.php">upload </a></button>
                        </div>
                    </form>
        ...
        <h3 class="text-dark text-center mb-3">Submissions</h3>
                ...
                <thead>
                     ...
                     <tbody>
                            <tr>
                                    ...
                                    <td></td>
                                    <td></td> 
              <!-- <td><span class="badge badge-success w-75 py-2"></span>view</td> 
