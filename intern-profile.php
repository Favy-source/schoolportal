...
<section>
    <div class="container-fluid">
        ...
        <h3 class="text-dark text-center mb-3">hope you have checked your NOTICES</h3>
        <table class="table table-color  table-hover">
                <thead>
                        <tr class="text-dark">
                            <th>you recieved a notice from your facilitator check it out</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
          ...
          <div class="container-fluid">
              <div class="row">
                  <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
                      <div class="row">
                            <div class="col-xl-6 col-12">
                                    <h4 class="text-dark p-3 mb-3">Create your own todo-list </h4>
                ...
                <ul class="list-inline text-center py-3">
                 <li class="list-inline-item">
                    ...
                    <li class="list-inline-item mr-4">
                           ...
                           <span class="h6 text-dark">Photo (optional)</span>
                           </a>
                           </li>
                           <li class="list-inline-item mr-4">
                                <a href="#"> <i class="fas fa-map-marker text-danger"></i>
                               <span class="h6 text-dark">Location (optional)</span>
                               </a>
                               </li>
                      ...
                      <form>
                          <div class="form-group">
                              ...
                              placeholder="tell us the challanges you facing,if none we expect nthe best from you">
